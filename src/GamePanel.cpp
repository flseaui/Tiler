...
GamePanel::GamePanel(Window * window, Camera * camera) : Panel(window, camera) {
	...
	buttons[0] = new TexButton(window, camera, "res/textures/sky_tile.png", 0, 0, 32, 32, 0);
	buttons[1] = new TexButton(window, camera, "res/textures/stone_tile.png", 0, 32, 32, 32, 1);
	buttons[2] = new TexButton(window, camera, "res/textures/cmbt.png", 0, 64, 32, 32, 2);
	buttons[3] = new TexButton(window, camera, "res/textures/clab.png", 0, 96, 32, 32, 3);
}
